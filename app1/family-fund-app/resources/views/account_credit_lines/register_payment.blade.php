...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Register payment</li>
</ol>
...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-header">
            <strong>Register payment &mdash; row #{{ $row->sequence_number ?? $row->id }}</strong>
            @if($account)
    ...
    <div class="card">
        ...
        <form method="POST"
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <input type="date" name="date" id="date" class="form-control"
                           ...
                           value="{{ old('date', \Illuminate\Support\Carbon::today()->toDateString()) }}">
                    <div class="form-text">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.0001" min="0.0001" name="shares" id="shares"
                           class="form-control"
                           value="{{ old('shares', number_format($row->shares_due, 4, '.', '')) }}" required>
                    <div class="form-text">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('credit_lines.global_payments') }}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
