<div style="position: relative; z-index: 1;">
    <canvas id="perfGraphLinReg" style="display: block !important; visibility: visible !important;"></canvas>
</div>
<div class="col-xs-12 mt-2">
    <ul class="small text-muted">
        <li><b>Predicted Value</b>: the predicted value of this fund based on linear regression</li>
