<div class="row address-entry">
    ...
    <div class="col-sm-3">
        {!! Form::text("addresses[$index][county]", isset($address) ? $address->county : null, ['class' => 'form-control', 'placeholder' => 'County']) !!}
    </div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-2">
        {!! Form::checkbox("addresses[$index][is_primary]", 1, isset($address) ? $address->is_primary : false, ['class' => 'is_primary']) !!} Primary
    </div>
    <div class="col-sm-1">
