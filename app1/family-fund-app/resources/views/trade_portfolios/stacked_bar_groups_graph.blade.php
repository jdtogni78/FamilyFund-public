...
<div class="card mb-4">
    <div class="card-header card-header-dark d-flex justify-content-between align-items-center flex-nowrap">
        <strong class="text-truncate" style="min-width: 0;"><i class="fa fa-layer-group me-2"></i>Portfolio Allocations by Group</strong>
        <a class="btn btn-sm btn-outline-light flex-shrink-0 ms-2" data-bs-toggle="collapse" href="#collapseGroupAllocations"
