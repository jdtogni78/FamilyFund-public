...
$chart = new DoughnutChart();
$chart->values = [2561.0068, 2561.0068, 2444.5954, 2296.397, 5000, 3556.0847, 7110.1289];
$chart->labels = ['LT', 'GT', 'GG', 'PG', 'NB', 'VT', 'Unallocated'];
$chart->createChart();
$chart->saveAs("Ring3.png");

$chart = new LineChart();
$chart->values = [25006.96, 25716.03, 25242.48, 26152.55, 27329.28, 27067.45, 32538.5, 34345.16, 36150.96, 34210.62, 37387.16, 37834.05, 39605.46, 31328.88, 31328.88];
...
$chart->values = [12, 22];
$chart->labels = ["Aao", "B12"];
$chart->titleValues = "AA";
$chart->titleLabels = "snauheontuhs";
$chart->createChart();
...
$chart = new BarChart();
$chart->values = [25006.96, 39605.46, 31328.88];
