...
class ReportScheduleTest extends TestCase
{
    ...
    public function scheduleProvider()
    {
        return [
            ...
            ['2024-02-05', '2024-02-06', '2024-02-05'], // maybe should error out as lan run is newer than today

            ['2024-02-15',         null, '2024-03-05'],
    ...
    public function testSchedules($today, $lastRun, $expected)
    {
        ...
        $runBy = $rs->shouldRunBy(new Carbon($today), new Carbon($lastRun));
