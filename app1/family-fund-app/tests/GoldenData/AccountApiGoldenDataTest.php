...
class AccountApiGoldenDataTest extends TestCase
{
    ...
    public function _test_account_balance_as_of($id, $asOf, $fund_name, $fund_id, $shares, $balance)
    {
        ...
        $arr['fund'] = [
            ...
            'name' => $fund->name,
            'goal' => $fund->goal,
            'withdrawal_yearly_expenses' => $fund->withdrawal_yearly_expenses,
            'withdrawal_net_worth_pct' => $fund->withdrawal_net_worth_pct,
            'withdrawal_rate' => $fund->withdrawal_rate,
            'expected_growth_rate' => $fund->expected_growth_rate,
            'independence_mode' => $fund->independence_mode,
